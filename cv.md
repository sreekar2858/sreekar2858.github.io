  ...
  <div class="container cc-experience">
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            ...
            <p style="text-align:center">Oct 2023 - Jul 2024</p>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <p><br>
                Topic: <strong>CFD Analysis of H2 Combustion Gas Turbines and Development of a Generative Design Toolchain</strong><br>
                • Gained comprehensive expertise in Siemens Energy’s advanced combustion simulation and automation toolchain, enhancing understanding of its features and applications.<br>
                • Investigated <strong>generative design</strong> methodologies and workflows, implementing and optimizing various design solutions for engineering challenges.<br>
                • Integrated self-learning algorithms into the design toolchain, improving its efficiency and adaptability for diverse scenarios.<br>
                • Applied the developed toolchain to practical cases involving H2 combustion gas turbines, focusing on <strong>minimizing boundary layer flashback</strong>.<br>
              </p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <a href= "/assets/pdf/Volocopter_Ref.pdf" target=_blank title="Reference Letter">Reference Letter: Download here</a>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <div class="h5"> RCI Lab, India</div>
